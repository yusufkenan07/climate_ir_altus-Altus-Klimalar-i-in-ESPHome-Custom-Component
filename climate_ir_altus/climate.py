...
climate_ir_altus_ns = cg.esphome_ns.namespace("climate_ir_altus")
AltusIrClimate = climate_ir_altus_ns.class_("AltusIrClimate", climate_ir.ClimateIR)
...
CONFIG_SCHEMA = climate_ir.climate_ir_with_receiver_schema(AltusIrClimate).extend(
    {
